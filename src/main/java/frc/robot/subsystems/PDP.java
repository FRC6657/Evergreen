...
public class PDP extends SubsystemBase {
  ...
  public PDP() {
    ...
    SuppliedValueWidget<Double> mAgitatorCurrent = Shuffleboard.getTab("PDP").addNumber("Agitator", () -> getCurrent(0))
        .withPosition(0, 0).withSize(2, 1);
    SuppliedValueWidget<Double> mBlinkinCurrent = Shuffleboard.getTab("PDP").addNumber("Blinkin", () -> getCurrent(0))
        .withPosition(2, 0).withSize(2, 1);
    SuppliedValueWidget<Double> mControlPanelCurrent = Shuffleboard.getTab("PDP")
        .addNumber("Control Panel", () -> getCurrent(0)).withPosition(0, 1).withSize(2, 1);
    ...
    SuppliedValueWidget<Double> mLimelightCurrent = Shuffleboard.getTab("PDP")
        .addNumber("Limelight", () -> getCurrent(0)).withPosition(0, 3).withSize(2, 1);
    SuppliedValueWidget<Double> mOuttakeCurrent = Shuffleboard.getTab("PDP")
        .addNumber("Outtake", () -> (getCurrent(0) + getCurrent(0))).withPosition(2, 3).withSize(2, 1);
