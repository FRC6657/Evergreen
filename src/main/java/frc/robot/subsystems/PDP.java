...
public class PDP extends SubsystemBase {
  ...
  SuppliedValueWidget<Double> mAgitatorCurrent = 
    Shuffleboard
      .getTab("PDP")
  ...
  SuppliedValueWidget<Double> mBlinkinCurrent = 
    Shuffleboard
      .getTab("PDP")
  ...
  SuppliedValueWidget<Double> mControlPanelCurrent = 
    Shuffleboard
      .getTab("PDP")
  ...
  SuppliedValueWidget<Double> mDrivetrainCurrent = 
    Shuffleboard
      .getTab("PDP")
  ...
  SuppliedValueWidget<Double> mIntakeCurrent = 
    Shuffleboard
      .getTab("PDP")
      .addNumber("Intake", () -> getCurrent(0))
      .withPosition(0, 2)
      .withSize(2, 1);
  SuppliedValueWidget<Double> mLiftCurrent = 
      Shuffleboard
        .getTab("PDP")
        .addNumber("Lift", () -> getCurrent(0))
        .withPosition(2, 2)
        .withSize(2, 1);
  SuppliedValueWidget<Double> mLimelightCurrent = 
        Shuffleboard
          .getTab("PDP")
          .addNumber("Limelight", () -> getCurrent(0))
          .withPosition(0, 3)
          .withSize(2, 1);
  SuppliedValueWidget<Double> mOuttakeCurrent = 
    Shuffleboard
      .getTab("PDP")
  ...
  SuppliedValueWidget<Double> mTotalCurrent = 
    Shuffleboard
      .getTab("PDP")
  ...
  SuppliedValueWidget<Double> mBatteryVoltage = 
    Shuffleboard
      .getTab("PDP")
